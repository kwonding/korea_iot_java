...
public class E_Optional {
    ...
    public static void main(String[] args) {
        ...
        arr[0] = "abc";
        // arr[1]과 arr[2]는 기본값 null (String 기본값 null)
        ...
        //2) Optional.ofNullable(T value): null 여부 상관없이 Optional 생성 (null일 경우 빈 Optional)
        Optional<String> optional2 = Optional.ofNullable(null);

        // 3) Optional.empty(): 비어있는 Optional 생성 (명시적으로 "값 없음"을 표현)
        ...
        // System.out.println(optional2.get()); // NoSuchElementException 예외 발생
        ...
        System.out.println(optional2.orElse("기본값 반환")); // 기본값 반환
        ...
        // 1) 필드에 사용 X
        // 2) 메서드 매개변수로 사용 X
        //      >> 반환값으로 사용 (메서드 호출 결과가 null일 수 있는 경우에만)
