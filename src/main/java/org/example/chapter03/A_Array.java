...
public class A_Array { // 클래스명 == 파일명 (파일명은 대문자로 시작! + UpperCamelCase 사용)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(scores1); // [I@2f92e0f4 참조 주소값
        ...
        System.out.println(fruits); // [Ljava.lang.String;@5305068a 주소값이 뜸
