...
// 1) 잘못된 설계 예시 - 새로운 학생 유형이 생길 때마다 if문 추가해야함 (기존 코드 수정 필요)
class LunchMenu {
...
// 변화가 발생에도 LunchMenuInterface를 구현한 클래스만 추가하면 된다 - 확장만 하면 됨!
class VegetarianStudent implements LunchMenuInterface {
