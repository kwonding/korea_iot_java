...
*           null 값이 할당될 수 있는 Wrapper 객체를 언박싱 할 경우 NPE(NullPointerException) 발생 위험
* */
...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        Object obj = Integer.valueOf(100); // 업캐스팅
        // int x = obj; - 자동 언박싱 불가. Object 타입은 컴파일 에러
        int x = ((Integer) obj).intValue(); // obj를 Integer로 다운캐스팅하고 int와 호환 (Object와 int는 서로 이해 못함)

        Integer a = null;
        //int abc = a; // NullPointerException
        ...
        // System.out.println(parseIntValue2); // NumberFormatException, 데이터 검증 필요
