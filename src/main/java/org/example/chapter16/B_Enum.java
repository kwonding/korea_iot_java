...
public class B_Enum {
    public static void main(String[] args) {
        ...
        System.out.println(Fruits.values()); // 배열의 주소값 출력 [Lorg.example.chapter16.Fruits;@5fd0d5ae

        for (Fruits fruitvalue: Fruits.values()) {
            System.out.print(fruitvalue + " "); // APPLE BANANA ORANGE
        }

        System.out.println(); // ln 제거로 인한 공백생성
        ...
        // Fruits orange2 = Fruits.valueOf("Orange"); - 대소문자까지 확인! // IllegalArgumentException
        ...
        System.out.println(anotherSize + "'s ml: " + size.getMl() + "ml"); // LARGE's ml: 200ml
