...
public class BookServiceImpl implements BookService{
    ...
    public BookServiceImpl() {
        ...
        items.add(new Book("4", "자바4", "책4", "이승아", "코리아", Category.FICTION));
        items.add(new Book("5", "자바5", "책5", "이승아", "코리아", Category.FANTASY));
        items.add(new Book("6", "자바6", "책6", "이승아", "코리아", Category.HISTORY));
        items.add(new Book("7", "자바7", "책7", "이승아", "코리아", Category.SCIENCE));
        items.add(new Book("8", "자바8", "책8", "이승아", "코리아", Category.SCIENCE));
        items.add(new Book("9", "자바9", "책9", "이승아", "코리아", Category.SCIENCE));
        items.add(new Book("10", "자바10", "책10", "이승아", "코리아", Category.FANTASY));
        items.add(new Book("11", "자바11", "책11", "이승아", "코리아", Category.FICTION));
    }
