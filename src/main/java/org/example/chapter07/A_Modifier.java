...
// cf) default class DefaultClass {} // 제어자 'default'은(는) 허용되지 않습니다 - default 키워드를 직접 명시 X
...
//protected class protectedClass {} // 제어자 'protected'은(는) 허용되지 않습니다 - 클래스 자체에 사용 불가! (중첩클래스만 가능)
class Modifier {}
...
//        privateClass.myMethod();
        //>> 'myMethod()'이(가) 'org.example.chpater07.PrivateClass'에서 private 액세스를 가집니다
        // : 접근제어자는 가시성을 나타냄
        // - private 필드와 메서드는 해당 클래스 내부에서만 접근 가능
