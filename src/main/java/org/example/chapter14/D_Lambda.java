...
@FunctionalInterface // 재정의하지 않는 추상 메서드 여러 개가 발견되었습니다
...
public class D_Lambda {
    public static void main(String[] args) {
        ...
        StringLength stringLength = str -> str.length(); // 실행문이 한 줄이면 return + {} 생략 가능
        // cf) 여러 줄일 경우: return + {} 둘 다 생략 불가
