...
class BaseballPlayer {
    ...
    BaseballPlayer(String name, double battingAverage, int homeRuns) {
        ...
        playerCount++; // 증감연산자 사용시 변수명과 기호를 붙여서 사용!
    }
...
public class E_Practice {
    public static void main(String[] args) {
        ...
        BaseballPlayer player2 = new BaseballPlayer("배혜진", 0.295, 12);
        BaseballPlayer player3 = new BaseballPlayer("최다영", 0.301, 30);
        BaseballPlayer player4 = new BaseballPlayer("이상은", 0.292, 15);
        ...
        System.out.println(BaseballPlayer.evaluateHomeRun(player3.homeRuns)); //홈런상 후보! 축하드립니다!
        System.out.println(BaseballPlayer.evaluateHomeRun(player4.homeRuns)); //홈런상 후보에 등록될 수 없습니다.
    }
}
