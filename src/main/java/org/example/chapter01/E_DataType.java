...
public class E_DataType {
    public static void main(String[] args) {
        ...
        // 1) float: 약 7자리 정도까지 정확하게 표현됨
        float f1 = 123.456789F;
        System.out.println(f1); // 123.45679 - 소수점 자리가 반올림 처리됨

        // 2) double: 약 15 ~ 16자리 정도까지 정확하게 표현
        double d1 = 123.4567898123456789;
        System.out.println(d1); // 123.45678981234568
