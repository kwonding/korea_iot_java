...
public class Main {
    public static void main(String[] args) {
        ...
        // 사용자 추가
        userService.addUser(new User(1, "권민현", "alsgus@example.com"));
        userService.addUser(new User(2, "안미향", "dksalgid@example.com"));
        userService.addUser(new User(3, "김승민", "tmdals@example.com"));
        ...
        // 이메일 수정
        try {
            userService.updateUserEmail(1, "gidaldks@example.com");
