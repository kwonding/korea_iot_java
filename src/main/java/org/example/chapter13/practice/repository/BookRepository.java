...
public class BookRepository {
    ...
    // 도서 저장소 (id값을 key로 저장 Map)
    private Map<String, Book> bookStore = new HashMap<>(); // DB 역할
    ...
    public Book save(Book book) {
        ...
        if (bookStore.containsKey(book.getId())) {
            // Map.containsKey(Key타입 데이터): 포함 여부를 boolean 값으로 반환
    ...
    public Book findById(String id) {
        ...
        * 책 저장소 List 사용 시
        *
        * 책 저장소 전체를 순회하여 현재 매개변수의 id값과 일치하는 요소를 필터링
        * */
    }
