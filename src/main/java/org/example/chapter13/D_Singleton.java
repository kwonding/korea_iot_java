...
class SchoolPrincipal {
    ...
    // cf) 생성자: 반환타입X, 접근제한자 가능, 이름은 클래스 명과 동일
...
public class D_Singleton {
    public static void main(String[] args) {
        ...
        System.out.println(example1); // Example@404b9385
        System.out.println(example2); // Example@6d311334
        System.out.println(example3); // Example@682a0b20
        System.out.println(example4); // Example@3d075dc0
