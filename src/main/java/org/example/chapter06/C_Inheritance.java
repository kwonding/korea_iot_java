...
//      - 자식 클래스의 생성자 호출 시 '반드시' 부모 클래스의 생성자가 호출(사용자 정의일 필요 X, 빈 생성자 O)
...
//        System.out.println(a);
        this(); // 'this()' 호출은 생성자 본문의 첫 번째 구문이어야 합니다 - 최상단!
        System.out.println(a);
    }
}
...
// class Animal {} // chapter06에 이미 존재하기 때문에 에러
...
class Cat extends Mammal {
    ...
    //      - super() 부모 클래스 생성자 호출 키워드가 정의되어 있음! (기본 생략)
    ...
    Cat(String name) {
       super(name);
        ...
        // - 여러개의 생성자가 있는 경우 (오버로딩) super()의 형태도 다양할 수 있음
//        this.name = name;
    }
