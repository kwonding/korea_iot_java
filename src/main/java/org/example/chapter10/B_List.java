...
//      - 추가/제거: 공간에 대한 정리 (중간 삽입 시 나머지 요소를 한 칸씩 이동) >> 시간 복잡도가 발생
...
public class B_List {
    public static void main(String[] args) {
        ...
        System.out.println(startTime); // 5601914381700
        ...
        System.out.println("ArrayList 삽입 시간: " + (endTime - startTime) + "ns"); // ArrayList 삽입 시간: 2129729700ns
        ...
        System.out.println("LinkedList 삽입 시간: " + (endTime - startTime) + "ns"); // LinkedList 삽입 시간: 26274300ns
    }
}
